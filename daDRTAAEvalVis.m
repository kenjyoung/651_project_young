function [subopt, sc, solved] = daDRTAAEvalVis(problem,maps,n,cutoff,errorRate,da,depth)
    ...
    %% Run the algorithm
    [solution, sc, solved] =  daDRTAA(iStart,map,goal,neighborhoodI,gCost,h,errorRate,maxTravel,da,depth,true);
