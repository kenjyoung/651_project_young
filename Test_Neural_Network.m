function [] = Test_Neural_Network(load_existing, name)
    %% Trained learner
    ...
    tt = tic;
    [subopt, ~, solved] = traineddaDRTAA_eval(learn,loadedScenario.problem,loadedScenario.maps,numProblems,cutoff,errorRate);
