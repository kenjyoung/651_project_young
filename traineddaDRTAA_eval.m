function [subopt, sc, solved] = traineddaDRTAA_eval(learner, problem,maps,nProblems,cutoff,errorRate)
...
for n = 1:nProblems
    ...
    [solution, sc(n), solved(n)] =  ...
        traineddaDRTAA(learner, iStart,map,goal,neighborhoodI,gCost,h,errorRate,maxTravel,true);
