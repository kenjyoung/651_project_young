function [] = Train_Neural_Network(load_existing, name)
    %% Trained learner
    ...
    tt = tic;
    [subopt, ~, solved] = learningdaDRTAA_train(learn,loadedScenario.problem,loadedScenario.maps,numProblems,cutoff,errorRate);
